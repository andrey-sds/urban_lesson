def send_mail(message, recipient, sender='university.help@gmail.com'):
    #  if (recipient or sender not in '@') or (   # невозможно отправить
    if ('@' not in sender and '@' not in recipient) or (  # успешная отправка
...
send_mail('Это сообщение для проверки связи', 'vasyok1337gmail.com')
